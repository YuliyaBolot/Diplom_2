...
class TestChangeUserData:
    ...
    def test_change_user_name(self, prepare_user):
        ...
        response_patch = requests.patch(Constants.url_user, headers={'Authorization': token}, data=user_change)
    ...
    def test_try_change_user_data_without_authorization(self, prepare_user, data_change):
        ...
        response = requests.patch(Constants.url_user, data=user_change)
